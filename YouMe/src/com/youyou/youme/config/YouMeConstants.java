package com.youyou.youme.config;

import android.annotation.SuppressLint;
import android.os.Environment;

/** 
 * @ClassName: YouMeConstants
 * @Description: TODO
 * @author smile
 * @date 2014-6-19 下午2:48:33
 */
@SuppressLint("SdCardPath")
public class YouMeConstants {
		/**
		 * 存放发送图片的目录
		 */
		public static String BMOB_PICTURE_PATH = Environment.getExternalStorageDirectory()	+ "/youme/image/";		
		/**
		 * 我的头像保存目录
		 */
		public static String MyAvatarDir = "/sdcard/youme/avatar/";
		/**
		 * 拍照回调
		 */
