...
import com.youyou.youme.util.ImageLoadOptions;
import com.youyou.youme.util.PhotoUtil;
...
//				btn_chat.setOnClickListener(this);
	...
	private void showAvatarPop() {
		...
		layout_photo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				File dir = new File(YouMeConstants.MyAvatarDir);
				if (!dir.exists()) {
					dir.mkdirs();
				}
				// 原图
				...
				startActivityForResult(intent,
						YouMeConstants.REQUESTCODE_UPLOADAVATAR_CAMERA);
			}
		});
		layout_choose.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				startActivityForResult(intent,
						YouMeConstants.REQUESTCODE_UPLOADAVATAR_LOCATION);
			}
		});
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch (requestCode) {
		case YouMeConstants.REQUESTCODE_UPLOADAVATAR_CAMERA:// 拍照修改头像
			if (resultCode == RESULT_OK) {
				...
				startImageAction(Uri.fromFile(file), 200, 200,
						YouMeConstants.REQUESTCODE_UPLOADAVATAR_CROP, true);
			}
			break;
		case YouMeConstants.REQUESTCODE_UPLOADAVATAR_LOCATION:// 本地修改头像
			if (avatorPop != null) {
				avatorPop.dismiss();
			}
			Uri uri = null;
			...
			break;
		case YouMeConstants.REQUESTCODE_UPLOADAVATAR_CROP:// 裁剪头像返回
			// TODO sent to crop
			if (avatorPop != null) {
				avatorPop.dismiss();
			}
		...
		if (extras != null) {
			...
			if (bitmap != null) {
				...
				String filename = new SimpleDateFormat("yyMMddHHmmss")
						.format(new Date());
				path = YouMeConstants.MyAvatarDir + filename;
				PhotoUtil.saveBitmap(YouMeConstants.MyAvatarDir, filename,
						bitmap, true);
				// 上传头像
